 ...
 * WebUser代表Web用户的持续状态.
 *
 * WebUser可以以应用组件的方式使用，组件id一般定义为'user'.
 * 也就是可以通过如下方式创建:
 * <code>Wind::getApp()->getWindFactory()->getInstance('user')</code>.
 *
 ...
 * <ol>
 * <li>用户提供认证所需的信息</li>
 * <li>基于用户提供的信息创建 {@link IUserIdentity identity 实例}</li>
 * <li>调用{@link IUserIdentity::authenticate} 来检测identity是否有效</li>
 * <li>如果有效，调用{@link WindWebUser::login} 让用户登录，并让浏览器跳转到 {@link returnUrl}</li>
 * <li>如果无效，从identity实例取得错误代码或消息并显示</li>
 * </ol>
 *
 ...
 * @since 1.0
 */
class WindWebUser extends WindModule implements IWebUser
{
	...
	public function loginRequired()
	{
		...
		if(($url=$this->loginUrl)!==null)
		{
			...
			throw new WindException('Login Required', 403);
	}
