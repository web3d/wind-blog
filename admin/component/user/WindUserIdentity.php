...
/**
 * WindUserIdentity is a base class for representing identities that are authenticated based on a username and a password.
 *
...
class WindUserIdentity extends WindBaseUserIdentity
{
	...
	{
		throw new WindException(get_class($this) . '::authenticate() must be implemented.');
	}
